---
name: communication-selfregulation
description: Guidelines for communicating with management and keeping LLM context focused.
---
...
| **Context tight?** | You notice the conversation is getting very long, **or** 2+ budget signals hold | Finish this step, then hand off |
...
2. **Summarize the current state** — what's done, what's left, any blockers.
3. Tell the user plainly: "Context is getting tight — handing off now; start a fresh conversation."
